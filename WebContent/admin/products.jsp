...
<html lang="en">
  ...
  <body id="reportsPage">
    ...
    <div class="search bar8">
        <form action="productdeal?req=search" method="post">
    ...
    <div class="container mt-5">
      <div class="row tm-content-row">
        ...
        <form action="productdeal?req=selectdelete" method="post">
              ...
              <table class="table table-hover tm-table-small tm-product-table">
                ...
                <c:forEach items="${products }" var="item">
                  <tr>
                    ...
                    <td>
                      <a href="productdeal?req=delete&id=${item.id }" class="tm-product-delete-link">
        ...
        <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 tm-block-col">
          <div class="tm-bg-primary-dark tm-block tm-block-product-categories">
                ...
                <tbody>
                	<c:forEach items="${categories }" var="item">
	                   <tr>
	                    ...
	                    <td class="tm-product-name">&#12288;${item.name }&#12288;&#12288;ID:${item.id}&#12288;Grade:${item.grade }</td>
	                    <td class="text-center">
	                      <a href="category?id=${item.id }&pid=${item.pid }&req=update" class="tm-product-delete-link">
	                        <i class="far fa-trash-alt tm-product-delete-icon"></i>
	                      </a>
	                    </td>
	                    </c:if>
            ...
            <button class="btn btn-primary btn-block text-uppercase mb-3">
             <a href="edit-category.jsp" > Add new category </a>
            </button>
          </div>
        </div>
      </div>
    ...
    <footer class="tm-footer row tm-mt-small">
      <div class="col-12 font-weight-light">
        <p class="text-center text-white mb-0 px-4 small">
          ...
          More Templates <a href="http://www.cssmoban.com/" target="_blank" title="古月">æ¨¡æ¿ä¹å®¶</a> - Collect from <a href="http://www.cssmoban.com/" title="ç½é¡µæ¨¡æ¿" target="_blank">ç½é¡µæ¨¡æ¿</a>
        </p>
      </div>
    </footer>
